...
extern double PenaltyScoreInSecond; /* 20s后每多算1秒实际罚分 (相对Cost) */
extern double ScheduleScoreInSecond; /* 20s内每少算1秒实际加分 (相对Cost) */
...
extern int Recombination; /* IPT, GPX2 or CLARIST */
